    ...
    <div className="content">
      <div className="content-body">
        ...
        <div className="politique-de-confidentialite">
          ...
          <p>
            Cette politique de confidentialité décrit comment Chaye recueille,
            utilise et protège vos données personnelles lorsque vous utilisez
            notre service de livraison de colis entre particuliers.
          </p>
          ...
          <p>
            ...
            personnelles et assurer leur confidentialité.
          </p>

          <h2>Partage des données</h2>
          <p>
            Nous ne partageons pas vos données personnelles avec des tiers sauf
            si cela est nécessaire pour la livraison de colis ou si requis par
            la loi.
          </p>
          ...
          <p>
            ...
            utilisateur. Vous pouvez choisir de les accepter ou de les
          ...
          <p>
            ...
            traitement de vos données en nous contactant.
          </p>
