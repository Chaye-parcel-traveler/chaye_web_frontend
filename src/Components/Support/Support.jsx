      ...
      <div className="content-body">
        ...
        <div className="content-main">
          <div className="support-container">
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  <li>
                    Facebook :{' '}
                    <a href="https://www.facebook.com/chaye">
                      facebook.com/chaye
                    </a>
                  </li>
                  <li>
                    Twitter :{' '}
                    <a href="https://www.twitter.com/chaye_support">
                      @chaye_support
                    </a>
                  </li>
                </ul>
            ...
            <p>
              Nous sommes disponibles du lundi au vendredi, de 9h à 18h (heure
              locale). N'hésitez pas à nous contacter pour toute question,
              préoccupation ou demande d'assistance concernant vos livraisons de
