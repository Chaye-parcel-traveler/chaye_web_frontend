    ...
    <div className="content">
      <div className="content-body">
        ...
        <div className="mentions-legales">
          ...
          <p>
            Ce site web est exploité par Chaye, une entreprise enregistrée en
            France.
          </p>
          ...
          <p>
            Tous les contenus de ce site, y compris les textes, images, logos,
            marques et tout autre élément, sont protégés par les lois sur la
          ...
          <p>
            ...
            <a href="/politiqueDeConfidentialite">ici</a>.
          </p>
          ...
          <p>
            ...
            sur ce site, mais nous ne pouvons garantir l'exactitude des
            informations. Nous ne sommes pas responsables des dommages directs
            ou indirects résultant de l'utilisation de ce site ou de son
            contenu.
          </p>

          <h2>7. Droit applicable</h2>
          <p>
            Ce site est régi par les lois en vigueur en France. Tout litige lié
            à ce site sera soumis à la juridiction exclusive des tribunaux de
            Paris, France.
          </p>
