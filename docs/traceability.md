...
| FE-TECH-006 | Frontend tests and async stability. | Added API client unit tests and removed the open-handle warning from the CRA test run. | `src/lib/api.test.js`, `src/App.test.js`. | implemented |
